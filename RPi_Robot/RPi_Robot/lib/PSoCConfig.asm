...
export LoadConfig_rpi_robot
export _LoadConfig_rpi_robot
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_rpi_robot
	lcall	LoadConfigTBL_rpi_robot_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration rpi_robot
;
;    Load configuration registers for rpi_robot.
...
;               CUR_PP
;
_LoadConfig_rpi_robot:
 LoadConfig_rpi_robot:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_rpi_robot_Bank0
    mov     X, <LoadConfigTBL_rpi_robot_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_rpi_robot_Bank1
    mov     X, <LoadConfigTBL_rpi_robot_Bank1

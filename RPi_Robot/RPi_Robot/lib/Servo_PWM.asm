;;*****************************************************************************
;;*****************************************************************************
;;  FILENAME: Servo_PWM.asm
;;   Version: 2.5, Updated on 2013/5/5 at 6:34:42
...
include "m8c.inc"
include "Servo_PWM.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  Servo_PWM_EnableInt
export _Servo_PWM_EnableInt
export  Servo_PWM_DisableInt
export _Servo_PWM_DisableInt
export  Servo_PWM_Start
export _Servo_PWM_Start
export  Servo_PWM_Stop
export _Servo_PWM_Stop
export  Servo_PWM_WritePeriod
export _Servo_PWM_WritePeriod
export  Servo_PWM_WritePulseWidth
export _Servo_PWM_WritePulseWidth
export  Servo_PWM_wReadPulseWidth
export _Servo_PWM_wReadPulseWidth
export  Servo_PWM_wReadCounter
export _Servo_PWM_wReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  wServo_PWM_ReadPulseWidth    ; deprecated
export _wServo_PWM_ReadPulseWidth    ; deprecated
export  wServo_PWM_ReadCounter       ; deprecated
export _wServo_PWM_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Servo_PWM_EnableInt
;
;  DESCRIPTION:
...
;
 Servo_PWM_EnableInt:
_Servo_PWM_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Servo_PWM_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Servo_PWM_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Servo_PWM_DisableInt:
_Servo_PWM_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Servo_PWM_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 Servo_PWM_WritePeriod:
_Servo_PWM_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Servo_PWM_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[Servo_PWM_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Servo_PWM_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 Servo_PWM_WritePulseWidth:
_Servo_PWM_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Servo_PWM_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[Servo_PWM_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Servo_PWM_wReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 Servo_PWM_wReadPulseWidth:
_Servo_PWM_wReadPulseWidth:
 wServo_PWM_ReadPulseWidth:                      ; this name deprecated
_wServo_PWM_ReadPulseWidth:                      ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Servo_PWM_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[Servo_PWM_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Servo_PWM_wReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 Servo_PWM_wReadCounter:
_Servo_PWM_wReadCounter:
 wServo_PWM_ReadCounter:                         ; this name deprecated
_wServo_PWM_ReadCounter:                         ; this name deprecated
   ...
   mov   A, reg[Servo_PWM_COMPARE_MSB_REG]       ; Save the Compare register on the stack
   push  A                                          ;
   mov   A, reg[Servo_PWM_COMPARE_LSB_REG]       ;
   push  A                                          ;  -stack frame now 2 bytes-
   Servo_PWM_Stop_M                              ; Disable the PWM function
   M8C_SetBank1                                     ;
   mov   A, reg[Servo_PWM_INPUT_LSB_REG]         ; save the LSB clock input setting
   push  A                                          ;   on the stack (now 3 bytes) and ...
                                                    ;   hold the clock low:
   mov   reg[Servo_PWM_INPUT_LSB_REG], INPUT_REG_NULL
   M8C_SetBank0                                     ; Extract the Count via DR2 register
   mov   A, reg[Servo_PWM_COUNTER_MSB_REG]       ; DR2 <- DR0 (in the MSB block)
   mov   A, reg[Servo_PWM_COMPARE_MSB_REG]       ; Stash the Count MSB on the stack
   push  A                                          ;  -stack frame is now 4 bytes
   mov   A, reg[Servo_PWM_COUNTER_LSB_REG]       ; DR2 <- DR0 (in the LSB block)
   mov   A, reg[Servo_PWM_COMPARE_LSB_REG]       ; Stash the Count LSB on the stack
   ...
   mov   reg[Servo_PWM_INPUT_LSB_REG], A         ;    and restore it
   M8C_SetBank0                                     ;
   Servo_PWM_Start_M                             ; Now re-enable the PWM function
